...
<img src="src/assets/module-icons/quick-settings.svg" width="18" alt="" />
**Quick Settings**: Control playback, jump tabs, and manage now playing from one
fast control surface.

<img src="src/assets/module-icons/auto-play.svg" width="18" alt="" />
**Auto Play**: Open YouTube Music and let playback start automatically so music
is ready when you are.

<img src="src/assets/module-icons/auto-skip.svg" width="18" alt="" />
**Auto Skip Disliked**: Automatically skip disliked tracks so your playlists
stay great from start to finish.

<img src="src/assets/module-icons/visualizer.svg" width="18" alt="" />
**Audio Visualizer**: Add responsive visualizer overlays and tune the look to
match your setup.

<img src="src/assets/module-icons/hotkeys.svg" width="18" alt="" />
**Hotkeys**: Control playback from any app or jump to the YouTube Music tab
instantly using just your keyboard.

<img src="src/assets/module-icons/mini-player.svg" width="18" alt="" />
**Mini Player**: Keep controls and now-playing visible in a compact PiP view
while you multitask.

<img src="src/assets/module-icons/notifications.svg" width="18" alt="" />
**Notifications**: Get customizable desktop notifications on track change and
playback resumption.

<img src="src/assets/module-icons/sleep-timer.svg" width="18" alt="" />
**Sleep Timer**: Stop playback by duration or clock time so your queue does not
run all night.
